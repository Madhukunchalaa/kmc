...
export const SERVICE_TIERS: Record<string, ServiceTier[]> = {
  ...
  candle: [
    ...
    { label: 'Psychic / Intuition / Spiritual', price: 2200, usdPrice: 45 },
    { label: 'Luck / Job / Career / Promotion', price: 2900, usdPrice: 60 },
    { label: 'Reconciliation / "Bring Back"', price: 3200, usdPrice: 65 },
    { label: 'Abundance / Wealth / Money / Prosperity', price: 3600, usdPrice: 75 },
    { label: 'Remove Obstacles (Financial/Relationship)', price: 3800, usdPrice: 80 },
    { label: 'Bindings (Fidelity / Loyalty)', price: 4200, usdPrice: 85 },
    { label: 'Fertility & Family Spells', price: 4200, usdPrice: 85 },
    { label: 'Success / Grand Success', price: 4500, usdPrice: 90 },
    { label: 'Love / Attraction / Soulmate', price: 4800, usdPrice: 95 },
    { label: 'Protection (Personal/Home/Business)', price: 5200, usdPrice: 105 },
    { label: 'Cleansing / Purification / House Blessing', price: 6300, usdPrice: 125 },
  ],
  spelljar: [
