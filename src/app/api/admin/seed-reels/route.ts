...
const DEFAULT_REELS = [
  ...
  { title: 'Crystal Packing Process',   caption: 'Watch how we carefully pack and wrap your crystals with love and positive energy.',                   src: `${BASE}/Video%207.mp4`, image: '/about-header.png',       order: 1 },
  { title: 'Candle Spell Rituals',      caption: 'Watch a real candle spell designed to manifest alignment and positivity.',                          src: `${BASE}/Video%202.mp4`, image: '/service-candle.png',     order: 2 },
  ...
  { title: 'Intuitively Chosen Tarot',  caption: 'Receive personalized spiritual guidance and clear answers to life questions.',                       src: `${BASE}/Video%203.mp4`, image: '/service-tarot.png',      order: 4 },
  ...
  { title: 'Pure Crystal Energy',       caption: 'Handpicked and ritually cleansed stones to invite harmony into your home.',                          src: `${BASE}/Video%205.mp4`, image: '/crystal-hero.png',       order: 6 },
];
