...
const DEFAULT_REELS = [
  { title: 'Candle Spell Rituals',      caption: 'Watch a real candle spell designed to manifest alignment and positivity.',                          src: `${BASE}/Video%207.mp4`, image: '/service-candle.png',     order: 0 },
  ...
  { title: 'Crystal Packing Process',   caption: 'Watch how we carefully pack and wrap your crystals with love and positive energy.',                   src: `${BASE}/Video%202.mp4`, image: '/crystal-hero.png',       order: 6 },
];
