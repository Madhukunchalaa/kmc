...
export const metadata = { title: 'Refund Policy · KrissMaagiic Crystals' };

export default function RefundPolicyPage() {
  return (
    <PolicyPage eyebrow="Returns & Refunds" title="Refund" highlight="Policy">
      <h2>Our Approach</h2>
      <p>
        Every crystal is intuitively selected and energetically prepared for its new home. Because of the personal, energetic nature of our products, we follow a careful — but caring — return and refund policy.
      </p>
