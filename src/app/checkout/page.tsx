    ...
    return (
      <section className="section-pad" style={{ paddingTop: '160px' }}>
        <div className="container text-center" style={{ maxWidth: 720 }}>
          ...
          {/* Beautiful Simulated Test Payment Notice */}
          <div className="test-success-card">
            <h4 className="test-success-card-title">
              🔮 Crystal Portal & Sandbox Phase 🔮
            </h4>
            <p className="test-success-card-text">
              KrissMaagiic is undergoing its final spiritual digital alignment. This order was completed in <strong>Testing Mode</strong> (no real money was charged).
              <br /><br />
              To manifest these crystals into your life and complete the actual purchase, please connect with Kriss directly on WhatsApp:
            </p>
            <a 
              href="https://wa.me/918096223929?text=Hi%20Kriss,%20I%20just%20placed%20a%20test%20order%20and%20would%20like%20to%20confirm%20it."
              target="_blank"
              rel="noopener noreferrer"
              className="whatsapp-cta-button"
            >
              <i className="fa-brands fa-whatsapp"></i>
              <span>Activate Order via WhatsApp (+91 80962 23929)</span>
            </a>
          </div>

          <p style={{ color: 'var(--text-light,#666)', marginBottom: '2.5rem' }}>
            We&apos;ve logged your test payment and registered your order. You&apos;ll receive confirmation details by email.
          </p>
